...
exports.toEncodedMap = exports.toDecodedMap = exports.setSourceContent = exports.maybeAddSegment = exports.maybeAddMapping = exports.fromMap = exports.allMappings = exports.addSegment = exports.addMapping = exports.GenMapping = void 0;
...
class GenMapping {
  constructor() {
    ...
    this._names = new _setArray.SetArray();
    this._sources = new _setArray.SetArray();
...
(() => {
  exports.addSegment = addSegment = (map, genLine, genColumn, source, sourceLine, sourceColumn, name, content) => {
    return addSegmentInternal(false, map, genLine, genColumn, source, sourceLine, sourceColumn, name, content);
  };

  exports.maybeAddSegment = maybeAddSegment = (map, genLine, genColumn, source, sourceLine, sourceColumn, name, content) => {
    return addSegmentInternal(true, map, genLine, genColumn, source, sourceLine, sourceColumn, name, content);
  };

  exports.addMapping = addMapping = (map, mapping) => {
    return addMappingInternal(false, map, mapping);
  };

  exports.maybeAddMapping = maybeAddMapping = (map, mapping) => {
    return addMappingInternal(true, map, mapping);
  };

  exports.setSourceContent = setSourceContent = (map, source, content) => {
    const {
      _sources: sources,
  ...
  exports.toDecodedMap = toDecodedMap = map => {
    const {
      file,
      sourceRoot,
      _mappings: mappings,
  ...
  exports.toEncodedMap = toEncodedMap = map => {
  ...
  exports.allMappings = allMappings = map => {
    const out = [];
    const {
      _mappings: mappings,
      _sources: sources,
