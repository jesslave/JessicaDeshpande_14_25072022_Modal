...
const _require = (0, _module.createRequire)(import
/*::(_)*/
...
function resolve(dirname, moduleName, absoluteImports) {
  ...
  try {
    if (nativeRequireResolve) {
      return _require.resolve(moduleName, {
        paths: [basedir]
      });
    } else {
...
function instantiateProvider(factory, options, missingDependencies, dirname, debugLog, babelApi) {
  ...
  const api = {
    ...
    assertDependency(name) {
      ...
      const dep = version === "*" ? name : "".concat(name, "@^").concat(version);
      const found = missingDependencies.all ? false : mapGetOr(depsCache, "".concat(name, " :: ").concat(dirname), () => has(dirname, name));
...
var _default = definePolyfillProvider;
