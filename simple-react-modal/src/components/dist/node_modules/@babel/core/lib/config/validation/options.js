...
function throwUnknownError(loc) {
  ...
  if (_removed.default[key]) {
    ...
    const unknownOptErr = new Error("Unknown option: ".concat((0, _optionAssertions.msg)(loc), ". Check out https://babeljs.io/docs/en/babel-core/#options for more information about options."));
