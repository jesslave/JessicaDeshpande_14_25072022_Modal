...
Command.prototype.missingArgument = function (name) {
  const message = "error: missing required argument '".concat(name, "'");
...
Command.prototype.missingMandatoryOptionValue = function (option) {
  const message = "error: required option '".concat(option.flags, "' not specified");
  console.error(message);
...
Command.prototype.unknownOption = function (flag) {
  ...
  const message = "error: unknown option '".concat(flag, "'");
  console.error(message);
...
Command.prototype.variadicArgNotLast = function (name) {
  const message = "error: variadic arguments must be last '".concat(name, "'");
  console.error(message);
